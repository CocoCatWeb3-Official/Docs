...
+ **remoteService**：应用后端服务地址，格式为 http://\{IP\}:\{port\}，默认为 [http://127.0.0.1:8080](http://127.0.0.1:8080) 。
...
+ **nodserverurl**：cococat-web 服务的 URL，默认为 [http://127.0.0.1:4567](http://127.0.0.1:4567)。
